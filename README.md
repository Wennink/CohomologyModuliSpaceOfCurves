...
The Sn-equivariant Hodge-Serre polynomial encodes the dimensions of the weight graded pieces of the (compactly supported) cohomology groups together with their action of the symmetric group Sn. More precisely it will consist of monomials of the form d\*t^k\*L^n\*s\[lambda\], where d is the dimension of the lambda-isotypical weight 2*n graded piece of the degree k (compactly supported) cohomology group.
